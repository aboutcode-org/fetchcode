...
from fetchcode.vcs.pip._internal.distributions import (
...
from fetchcode.vcs.pip._internal.utils.filesystem import copy2_fixed
from fetchcode.vcs.pip._internal.utils.hashes import MissingHashes
...
if MYPY_CHECK_RUNNING:
    ...
    from fetchcode.vcs.pip._internal.distributions import AbstractDistribution
    ...
    from fetchcode.vcs.pip._internal.network.download import Downloader
    from fetchcode.vcs.pip._internal.req.req_install import InstallRequirement
    from fetchcode.vcs.pip._internal.req.req_tracker import RequirementTracker
