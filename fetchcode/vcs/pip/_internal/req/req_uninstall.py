...
from fetchcode.vcs.pip._internal.exceptions import UninstallationError
from fetchcode.vcs.pip._internal.locations import bin_py, bin_user
from fetchcode.vcs.pip._internal.utils.compat import WINDOWS, cache_from_source, uses_pycache
