...
class Package(BasePackage):
    ...
    homepage_url = String(
        label="homepage URL", help="URL to the homepage for this package."
    )
    ...
    sha1 = String(
        label="SHA1 checksum", help="SHA1 checksum for this download in hexadecimal"
    )

    md5 = String(
        label="MD5 checksum", help="MD5 checksum for this download in hexadecimal"
    )
    ...
    code_view_url = String(
        label="code view URL", help="a URL where the code can be browsed online"
    )
