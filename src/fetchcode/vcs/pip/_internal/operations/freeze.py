...
from fetchcode.vcs.pip._vendor.pkg_resources import RequirementParseError
...
if MYPY_CHECK_RUNNING:
    ...
    from fetchcode.vcs.pip._vendor.pkg_resources import Distribution, Requirement
...
def get_requirement_info(dist):
    ...
    from fetchcode.vcs.pip._internal.vcs import vcs, RemoteNotFoundError
