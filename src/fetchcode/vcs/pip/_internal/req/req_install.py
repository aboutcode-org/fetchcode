...
from fetchcode.vcs.pip._vendor import pkg_resources, six
...
from fetchcode.vcs.pip._vendor.pep517.wrappers import Pep517HookCaller

from fetchcode.vcs.pip._internal.build_env import NoOpBuildEnvironment
...
from fetchcode.vcs.pip._internal.operations.install.legacy import LegacyInstallFailure
from fetchcode.vcs.pip._internal.operations.install.legacy import (
    install as install_legacy,
)
from fetchcode.vcs.pip._internal.operations.install.wheel import install_wheel
from fetchcode.vcs.pip._internal.pyproject import (
    load_pyproject_toml,
    make_pyproject_path,
)
...
from fetchcode.vcs.pip._internal.utils.packaging import get_metadata
