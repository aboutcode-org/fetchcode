...
from fetchcode.vcs.pip._vendor.requests.models import CONTENT_CHUNK_SIZE

from fetchcode.vcs.pip._internal.cli.progress_bars import DownloadProgressProvider
...
from fetchcode.vcs.pip._internal.network.utils import response_chunks
