...
from fetchcode.vcs.pip._vendor import requests, six, urllib3
from fetchcode.vcs.pip._vendor.cachecontrol import CacheControlAdapter
from fetchcode.vcs.pip._vendor.requests.adapters import BaseAdapter, HTTPAdapter
...
from fetchcode.vcs.pip._internal.utils.compat import has_tls, ipaddress
